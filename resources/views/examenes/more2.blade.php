...
<div class="container">
	...
	<div class="row">
		<div class="col">
			<form class="form-group" method="POST" action="/update-diagnostico/{{$id_examen}}/{{$bandera}}">
			@csrf
				<textarea name="diagnostico" class="form-control" rows="5" placeholder="Añade un nuevo diagnostico al examen." required="required"></textarea>
				<br>
				<button type="submit" class="btn btn-primary" style="background-color: #0E6655">Enviar</button>
			</form>
		</div>
